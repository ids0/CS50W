# Generated by Django 3.1.3 on 2020-12-22 00:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('likes', models.ManyToManyField(through='network.Like', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.AddField(
            model_name='user',
            name='likes',
            field=models.ManyToManyField(related_name='liked_posts', through='network.Like', to='network.Post'),
        ),
        migrations.AddField(
            model_name='user',
